...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" data-theme="emerald">
    <head>
        ...
        <title>Maritozzo - @yield('title')</title>
    </head>
    ...
    <body claa="p-2">
        ...
        <!-- FOTTER -->
        <footer class="footer p-2 text-neutral-content inset-x-0 bottom-0  bg-accent mt-8">
            <div>
                ...
                <p>Maritozzo<br/>Providing reliable tech since 1992</p>
            </div> 
            <div class="ml-12">
